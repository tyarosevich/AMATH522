...
# This is the fit of the parameters. Presumably mle2 varies the parameters, and maximizes
# some result, in this case the -ll returned from nll. By maximizing it, it's making it
# as small as possible in this case since it's maximizing a negative value. So all we're doing here is varying parameters
# timestepping ALL the equations, then comparing all the C/D values against the data, and minimizing 
# the difference under the assumption of a Poisson distribution. 
