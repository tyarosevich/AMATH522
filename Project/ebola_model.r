...
# some result, in this case the -ll returned from nll By maximizing it, presumably it's making it
# as small as possible in this case (since it's negative). So all we're doing here is varying parameters
# timestepping ALL the equations, then comparing all the C/D values against hte data, and minimizing 
# some difference in poisson distribution error. 
